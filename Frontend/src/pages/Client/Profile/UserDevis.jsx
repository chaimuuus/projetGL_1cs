...
export default function UserDevis() {
    ...
    const activeTab = (() => {
        if (location.pathname.endsWith("userdevisrp")) return "UserDevisrp";
        return "UserDevisRecus";
    })();
                ...
                >
                    ...
                    <div className="px-6 pt-4">
                        ...
                        <div className="flex gap-4 pl-6 text-textBlack">
                            <Link
                                to=""
                                className={`pb-2 ${activeTab === "UserDevisRecus" ? "border-b-blue-600 border-b-2" : ""}`}
                            >
                                Devis envoyé
                            </Link>
                            <Link
                                to="userdevisrp"
                                className={`pb-2 ${activeTab === "UserDevisrp" ? "border-b-blue-600 border-b-2" : ""}`}
                            >
                                Devis de réponse
                            </Link>
