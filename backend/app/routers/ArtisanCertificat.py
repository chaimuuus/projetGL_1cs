...
async def addCertificat(
    ...
    file_name = str(profile["user"]["id"])+image_file.filename
    ...
    """)
    result = db.execute(query,{"title" :title,"institution" : institution,"description":description,"obtaining_date":obtaining_date,"image_file":SAVE_PATH+"/"+str(file_name),"artisan_id":profile["user"]["id"]})
